...
If there are manymany bullets, the version heading should be following issues 
...
should also appear in their __own section at the top__. Each bullet should include
